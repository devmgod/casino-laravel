            ...
            <div class="card border-primary">
                ...
                <div id="tab-bonuses" class="collapse">
                    <div class="card-body text-body">
                        ...
                        <div class="form-row">
                            <label class="ml-1">{{ __('Faucet') }}</label>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">{{ __('Allow to claim') }} >=</span>
                                    </div>
                                    <input type="text" name="BONUSES_FAUCET_AMOUNT" class="form-control" value="{{ config('settings.bonuses.faucet.amount') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">{{ __('credits') }}</span>
                                    </div>
                                </div>
                                <small>{{ __('Set amount to 0 to disable faucet.') }}</small>
                            </div>
                            <div class="form-group col-lg-6">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="BONUSES_FAUCET_INTERVAL" class="form-control" value="{{ config('settings.bonuses.faucet.interval') }}">
                                    <div class="input-group-append">
