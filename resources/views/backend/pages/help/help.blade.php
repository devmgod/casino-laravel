...
RewriteRule (.*) https://%{HTTP_HOST}%{REQUEST_URI} [R=301,L]
  ...
  <div class="card border-primary">
    <div class="card-header border-primary">
      <h5 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#tab-22" aria-expanded="true">
          {{ __('How to change the website logo?') }}
        </button>
      </h5>
    </div>
    <div id="tab-22" class="collapse">
      <div class="card-body text-body">
        <p>
...
RECAPTCHA_SECRET_KEY
  ...
  <div class="card border-primary">
    <div class="card-header border-primary">
      <h5 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#tab-21" aria-expanded="true">
          {{ __('How to get support?') }}
        </button>
      </h5>
    </div>
    <div id="tab-21" class="collapse">
      <div class="card-body text-body">
        <p>
